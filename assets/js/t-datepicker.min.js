            ...
            for (var i = 0; i < toDayElement.length; i++) {
                ...
                toDayElement[i].onclick = function (e) {
                    ...
                    if ($(this).parents(".t-check-in").hasClass("t-check-in") === true) {
                        ...
                        if (get_utc === settings.startDate && $(this).hasClass("departure_date") === false && dataUTC[0] >= settings.startDate) {
                    ...
                    if ($(this).parents(".t-check-out").hasClass("t-check-out") === true) {
                        if ($(this).hasClass("departure_date") === true) {
                            return;
                        }
                        if ($(this).parents(".t-datepicker").find(".t-start").length === 0 && $(this).hasClass("return_date") === true) {
                            return;
                        }
